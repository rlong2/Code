...
class assignment1{
	...
	public static void main(String[] args){
		...
		int[] array = new int[25];                               // Create empty array to hold 25 ints

		print(array);                                            // Prints random array 
		
		System.out.println("\nSum        = " + sum(array));      // Sums the array
		
		System.out.println("Average    = " +   average(array));  // Averages the array

		System.out.println("Median     = " +   median(array));   // Calculates median of array
		
		System.out.println("Mode value = " +   mode(array));     // Calculates mode of array
		
		write(array);                                            // Outputs the array to assignment1.txt 
                                                                 
		read(array);                                             // Reads data from assignment1.txt 
