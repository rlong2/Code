...
import pprint # pretty print makes dictionaries look nice :)

# HUGE Shakespeare Text below. Scroll to bottom for code
# The ''' foo ''' does mutiline comments
...
for character in message.upper():# counts upper and lower together
    count.setdefault(character, 0) # 1st iteration sets count for a char to 0
