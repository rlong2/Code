...
This program gets text from the clipboard,
finds all the phone numbers and email addresses in the text,
and pastes them to the clipboard

Tested using:
https://www.sde.idaho.gov/_files/SDE-Staff-Directory-Name.pdf
https://jfs.ohio.gov/County/County_Directory.pdf
https://www.nj.gov/health/lh/documents/LocalHealthDirectory.pdf
http://parecovery.pa.gov/cs/groups/webcontent/documents/document/c_087843.pdf
...
print('\nEmails and phone numbers copied to system clipboard')